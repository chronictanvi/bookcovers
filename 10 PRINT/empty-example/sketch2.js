...
function breakGrid() {
  ...
  gridCount = parseInt(map(len, minTitle, maxTitle, 2, 11)); // play around with 2/11
}
...
function setup() {
  ...
  var coverBaseColor = color(200, 153, 0);
...
function draw() {
  ...
  for (var r = 0; r < table.getRowCount(); r++) {
    ...
    titleFont = textFont("Roboto Mono");
    authorFont = textFont("Roboto Mono");
    titleFontSize = parseInt(coverWidth * 0.08);
    authorFontSize = parseInt(coverWidth * 0.07);
    titleHeight = parseInt((coverHeight - coverWidth - (coverHeight * margin / 100)) * 0.75);
    authorHeight = parseInt((coverHeight - coverWidth - (coverHeight * margin / 100)) * 0.25);
